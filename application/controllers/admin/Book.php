...
class Book extends Admin_Controller {
    ...
    public function barcode_list()
    {
        ...
        if ($this->input->post('create')) {
           ...
           $_SESSION['book_name']=$bname;
           $_SESSION['book_number']=$bnum;

           
       }
       if ($this->input->post('barcode')) {
           $bar_num=$this->input->post('bar_num');
           $barcode_image=$this->input->post('barcode_image');
           $_SESSION['bar_num']=$bar_num;
           $_SESSION['barcode_image']=$barcode_image;
            redirect('admin/book/print_barcode');
       ...
       // if (isset($q)) {
       //   $this->load->view('layout/header');
       //  $this->load->view('admin/book/barcode_list',$d);
       //  $this->load->view('layout/footer');
    
       // }
        $this->load->view('layout/header');
        $this->load->view('admin/book/barcode_list');
        $this->load->view('layout/footer');
    
    }
public function pri_bar()
{
   $this->load->view('layout/header');
        $this->load->view('admin/book/barcode_print');
        $this->load->view('layout/footer');
}
    // public function bar_sto()
    // {
    //     $bar_num=$this->input->post('bar_num');
    //     $barcode_image=$this->input->post('barcode_image');
    //     $data1['d']=array(
    //      "bar_num"=>$this->input->post('bar_num'),
    //        "barcode_image"=>$this->input->post('barcode_image'));
    //     return redirect('admin/book/barcode_list?q='.$bar_num.'&img='.$barcode_image);
    // }
