        ...
        <ul class="sidebar-menu verttop">
                    ...
                    <li class="treeview <?php echo set_Topmenu('front_office'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('visitor_book', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('admin/visitors'); ?>"><a href="<?php echo base_url(); ?>admin/visitors"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('visitor_book'); ?></a></li>
                            ...
                            if ($this->rbac->hasPrivilege('phone_call_log', 'can_view')) {
                                ...
                                <li style="display: none;" class="<?php echo set_Submenu('admin/generalcall'); ?>"><a href="<?php echo base_url(); ?>admin/generalcall"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('phone_call_log'); ?></a></li>
                ...
                if (($this->rbac->hasPrivilege('student', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php
                            //if ($this->rbac->hasPrivilege('student_list')) {
                                ?>

                                <li class="<?php echo set_Submenu('admin/studentlist'); ?>"><a href="<?php echo base_url(); ?>admin/studentlist"><i class="fa fa-angle-double-right"></i> Student List</a></li>
                            <?php //} ?>
                            ...
                            if ($this->module_lib->hasActive('online_admission')) {
                                if ($this->rbac->hasPrivilege('online_admission', 'can_view')) {
                                    ...
                                    <li style="display: none;" class="<?php echo set_Submenu('onlinestudent'); ?>"><a href="<?php echo site_url('admin/onlinestudent'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('online') . " " . $this->lang->line('admission'); ?></a></li>
                            ...
                            if ($this->rbac->hasPrivilege('disable_student', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('student/disablestudentslist'); ?>"><a href="<?php echo base_url(); ?>student/disablestudentslist"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('disabled_students'); ?></a></li>
                                <?php
                            }
                            if ($this->module_lib->hasActive('multi_class')) {
                                if ($this->rbac->hasPrivilege('multi_class_student', 'can_view')) {
                                    ?>
                                    <li style="display: none;" class="<?php echo set_Submenu('student/multiclass'); ?>"><a href="<?php echo base_url(); ?>student/multiclass"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('multiclass') . " " . $this->lang->line('student'); ?></a></li>
                                    <?php
                                }
                            }
                            ...
                            if ($this->rbac->hasPrivilege('student_categories', 'can_view')) {
                                ...
                                <li style="display: none;" class="<?php echo set_Submenu('category/index'); ?>"><a href="<?php echo base_url(); ?>category"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student_categories'); ?></a></li>
                            ...
                            if ($this->rbac->hasPrivilege('student_houses', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('admin/schoolhouse'); ?>"><a href="<?php echo base_url(); ?>admin/schoolhouse"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('house'); ?></a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('disable_reason', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('student/disable_reason'); ?>"><a href="<?php echo base_url(); ?>admin/disable_reason"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('disable') . " " . $this->lang->line('reason'); ?></a></li>
                                <?php
                            }
                            ?>
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-bus ftlayer"></i> <span>Fee</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                                <!-- <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/fee"><i class="fa fa-angle-double-right"></i>Add fee</a></li> -->
                                <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/fee/academics-fee-create"><i class="fa fa-angle-double-right"></i>Academics Collect Fee</a></li>
                                <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/fee/hostel-fee-create"><i class="fa fa-angle-double-right"></i>Hostel Collect Fee</a></li>
                                <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/fee/transport-fee-create"><i class="fa fa-angle-double-right"></i>Transport Collect Fee</a></li>
                                <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/fee"><i class="fa fa-angle-double-right"></i>Refund Fee</a></li>
                                <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/concessionfee"><i class="fa fa-angle-double-right"></i>Concession Fee Add</a></li>
                                <li class="<?php echo set_Submenu('fee/index'); ?>"><a href="<?php echo base_url(); ?>admin/concessionfeelist"><i class="fa fa-angle-double-right"></i>Concession Fee List</a></li>
                                <?php
            ...
            if ($this->module_lib->hasActive('fees_collection')) {
                if (($this->rbac->hasPrivilege('collect_fees', 'can_view') ||
                    ...
                    ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        <a href="#">
            ...
            if ($this->module_lib->hasActive('income')) {
                if (($this->rbac->hasPrivilege('income', 'can_view') ||
                    ...
                    <li style="display:none;" class="treeview <?php echo set_Topmenu('Income'); ?>">
                        <a href="#">
            ...
            if ($this->module_lib->hasActive('expense')) {
                if (($this->rbac->hasPrivilege('expense', 'can_view') ||
                    ...
                    ?>
                    <li style="display:none;" class="treeview <?php echo set_Topmenu('Expenses'); ?>">
                        <a href="#">
            ...
            if ($this->module_lib->hasActive('examination')) {
                if (($this->rbac->hasPrivilege('exam_group', 'can_view') ||
                    ...
                    ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                        <a href="#">
            ...
            if ($this->module_lib->hasActive('lesson_plan')) {
                if (($this->rbac->hasPrivilege('manage_lesson_plan', 'can_view')) || ($this->rbac->hasPrivilege('manage_syllabus_status', 'can_view')) || ($this->rbac->hasPrivilege('lesson', 'can_view')) || ($this->rbac->hasPrivilege('topic', 'can_view'))) {
                    ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('lessonplan'); ?>">
                        <a href="#">
        ...
        <?php } ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) { ?>
                                <li style="display:none;" class="<?php echo set_Submenu('Academics/timetable'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/classreport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('class_timetable'); ?></a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('teachers_time_table', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('Academics/timetable/mytimetable'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/mytimetable"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('teachers') . " " . $this->lang->line('timetable') ?></a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('assign_class_teacher', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('admin/teacher/assign_class_teacher'); ?>"><a href="<?php echo base_url(); ?>admin/teacher/assign_class_teacher"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('assign_class_teacher'); ?></a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('promote_student', 'can_view')) {
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('stdtransfer/index'); ?>"><a href="<?php echo base_url(); ?>admin/stdtransfer"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('promote_students'); ?></a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('subject_group', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('subjectgroup/index'); ?>"><a href="<?php echo base_url('admin/subjectgroup'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('subject') . " " . $this->lang->line('group') ?></a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('Academics/subject'); ?>"><a href="<?php echo base_url(); ?>admin/subject"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('subjects'); ?></a></li>
                                <?php
                            }
                    ...
                    <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('staff_payroll', 'can_view')) {
                                ...
                                <li style="display: none;" class="<?php echo set_Submenu('admin/payroll'); ?>"><a href="<?php echo base_url(); ?>admin/payroll"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('payroll'); ?></a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('approve_leave_request', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('admin/leaverequest/leaverequest'); ?>"><a href="<?php echo base_url(); ?>admin/leaverequest/leaverequest"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('approve_leave_request'); ?></a></li>
                            ...
                            if ($this->rbac->hasPrivilege('teachers_rating', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('HR/rating'); ?>"><a href="<?php echo base_url(); ?>admin/staff/rating"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('teachers') . " " . $this->lang->line('rating'); ?></a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('disable_staff', 'can_view')) {
                                ...
                                <li style="display: none;" class="<?php echo set_Submenu('HR/staff/disablestafflist'); ?>"><a href="<?php echo base_url(); ?>admin/staff/disablestafflist"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('disabled_staff'); ?></a></li>
                    <?php } ?>
                        </ul>
                    </li>
                    <?php
            ...
            if ($this->module_lib->hasActive('communicate')) {
                if (($this->rbac->hasPrivilege('notice_board', 'can_view') ||
                    ...
                    ?>
                    <li style="display: none;" class = "treeview <?php echo set_Topmenu('Communicate'); ?>">
                        <a href = "#">
            ...
            if ($this->module_lib->hasModule('gmeet_live_classes')) {
                if ($this->module_lib->hasActive('gmeet_live_classes')) {
                    if (($this->rbac->hasPrivilege('gmeet_live_classes', 'can_view')) || ($this->rbac->hasPrivilege('gmeet_live_meeting', 'can_view')) || ($this->rbac->hasPrivilege('gmeet_live_meeting_report', 'can_view')) || ($this->rbac->hasPrivilege('gmeet_live_classes_report', 'can_view'))) {
                        ?>
                        <li style="display: none;" class="treeview <?php echo set_Topmenu('gmeet'); ?>">
                            <a href="#">
...
if ($this->module_lib->hasActive('download_center')) {
    if (($this->rbac->hasPrivilege('upload_content', 'can_view'))) {
        ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('Download Center'); ?>">
                        <a href="#">
        ...
        <?php } ?>
            ...
            if ($this->module_lib->hasActive('homework')) {
                if (($this->rbac->hasPrivilege('homework', 'can_view'))) {
                    ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('Homework'); ?>">
                        <a href="#">
        ...
        <?php }if ($this->rbac->hasPrivilege('issue_return', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('member/index'); ?>"><a href="<?php echo base_url(); ?>admin/book/barcode_list"><i class="fa fa-angle-double-right"></i>Barcode Print</a></li>
                            <?php } ?>
            ...
            if ($this->module_lib->hasActive('inventory')) {
                if (($this->rbac->hasPrivilege('issue_item', 'can_view') ||
                    ...
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Office Inventory'); ?>">
                        <a href="#">
                            <i class="fa fa-object-group ftlayer"></i> <span>Office Inventory</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
            ...
            if ($this->module_lib->hasActive('inventory')) {
                if (($this->rbac->hasPrivilege('hostelitem_issue', 'can_view') ||
                        $this->rbac->hasPrivilege('hostelitem_stock', 'can_view') ||
                        $this->rbac->hasPrivilege('hostelitem', 'can_view') ||
                        $this->rbac->hasPrivilege('hostelitem_category', 'can_view') ||
                        $this->rbac->hasPrivilege('hostelitemstore', 'can_view') ||
                        $this->rbac->hasPrivilege('hostelsupplier', 'can_view'))) {
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Inventory'); ?>">
                        <a href="#">
                            <i class="fa fa-object-group ftlayer"></i> <span>Hostel Inventory</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('hostelitem_issue', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('hostelissueitem/index'); ?>"><a href="<?php echo base_url(); ?>admin/hostelitemissue"><i class="fa fa-angle-double-right"></i>Issue item</a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('hostelitem_stock', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('hostelitemstock/index'); ?>"><a href="<?php echo base_url(); ?>admin/hostelitemstock"><i class="fa fa-angle-double-right"></i>Add item stock</a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('hostelitem', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('hostelitem/index'); ?>"><a href="<?php echo base_url(); ?>admin/hostelitem"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_item'); ?></a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('hostelitem_category', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('hostelitemcategory/index'); ?>"><a href="<?php echo base_url(); ?>admin/hostelitemcategory"><i class="fa fa-angle-double-right"></i>Item category</a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('hostelitemstore', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('hostelitemstore/index'); ?>"><a href="<?php echo base_url(); ?>admin/hostelitemstore"><i class="fa fa-angle-double-right"></i>Item store</a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('hostelsupplier', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('hostelitemsupplier/index'); ?>"><a href="<?php echo base_url(); ?>admin/hostelitemsupplier"><i class="fa fa-angle-double-right"></i>Item supplier</a></li>
                    <?php } ?>
                        </ul>
                    </li>
                    <?php
            ...
            if ($this->module_lib->hasActive('transport')) {
                if (($this->rbac->hasPrivilege('routes', 'can_view') ||
                        $this->rbac->hasPrivilege('transport_form', 'can_view') ||
                        $this->rbac->hasPrivilege('subroute', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Transport'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php
                            //if ($this->rbac->hasPrivilege('transport_form', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('transport/index'); ?>"><a href="<?php echo base_url(); ?>admin/transport"><i class="fa fa-angle-double-right"></i>Transport form</a></li>
                                <?php
                            //}

                            // if ($this->rbac->hasPrivilege('subroute', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('subroute/index'); ?>"><a href="<?php echo base_url(); ?>admin/subroute"><i class="fa fa-angle-double-right"></i>Add Subroute</a></li>
                                <?php
                            //}
  ...
  <?php
            if ($this->module_lib->hasActive('hostel')) {
                if (($this->rbac->hasPrivilege('hostel_rooms', 'can_view') ||
                        $this->rbac->hasPrivilege('add_hostel', 'can_view')||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Hostel'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            //if ($this->rbac->hasPrivilege('add_hostel', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('addroom/index'); ?>"><a href="<?php echo base_url(); ?>admin/addroom"><i class="fa fa-angle-double-right"></i> Hostel Form</a></li>
                                <?php
                            //}
            ...
            if ($this->module_lib->hasActive('certificate')) {
                if (($this->rbac->hasPrivilege('student_certificate', 'can_view') ||
                    ...
                    ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('Certificate'); ?>">
                        <a href="#">
            ...
            if ($this->module_lib->hasActive('front_cms')) {
                if (($this->rbac->hasPrivilege('event', 'can_view') ||
                    ...
                    ?>
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('Front CMS'); ?>">
                        <a href="#">
...
if ($this->module_lib->hasActive('alumni')) {
    if (($this->rbac->hasPrivilege('manage_alumni', 'can_view')) || ($this->rbac->hasPrivilege('events', 'can_view'))) {
        ?>
                    ...
                    <li style="display: none;" class="treeview <?php echo set_Topmenu('alumni'); ?>">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->module_lib->hasActive('online_examination')) {
                                if (($this->rbac->hasPrivilege('online_exam_wise_report', 'can_view') ||
                                    ...
                                    ?>
                                    <li style="display: none;" class="<?php echo set_Submenu('Reports/online_examinations'); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam/report"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('online') . " " . $this->lang->line('examinations'); ?></a></li>
                                    <?php
                                }
                            }
                            ...
                            if ($this->module_lib->hasActive('lesson_plan')) {
                                if (($this->rbac->hasPrivilege('syllabus_status_report', 'can_view') || $this->rbac->hasPrivilege('teacher_syllabus_status_report', 'can_view'))) {
                                    ?>
                                    <li style="display: none;" class="<?php echo set_Submenu('Reports/lesson_plan'); ?>"><a href="<?php echo base_url(); ?>report/lesson_plan"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('lesson_plan'); ?></a></li>
                                    <?php
                                }
                            }
                            if ($this->module_lib->hasActive('human_resource')) {
                            ...
                            if ($this->module_lib->hasActive('alumni')) {
                                if ($this->rbac->hasPrivilege('alumni_report', 'can_view')) {
                                    ?>
                                    <li style="display: none;" class="<?php echo set_Submenu('Reports/alumni_report'); ?>"><a href="<?php echo base_url(); ?>report/alumnireport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('alumni'); ?></a></li>
                                    <?php
                                }
                            }
                            if ($this->rbac->hasPrivilege('user_log', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('Reports/userlog'); ?>"><a href="<?php echo base_url(); ?>admin/userlog"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('user_log'); ?></a></li>
                                        <?php
                            }
                            if ($this->rbac->hasPrivilege('audit_trail_report', 'can_view')) {
                                ?>
                                <li style="display: none;" class="<?php echo set_Submenu('audit/index'); ?>"><a href="<?php echo base_url(); ?>admin/audit"><i class="fa fa-angle-double-right"></i>
                    ...
                    <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('session_setting', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('sessions/index'); ?>"><a href="<?php echo base_url(); ?>sessions"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('session_setting'); ?></a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('payment_methods', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('admin/paymentsettings'); ?>"><a href="<?php echo base_url(); ?>admin/paymentsettings"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('payment_methods'); ?></a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('print_header_footer', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('admin/print_headerfooter'); ?>"><a href="<?php echo base_url(); ?>admin/print_headerfooter"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('print_headerfooter'); ?></a></li>
                                <?php
                            }
                            if ($this->module_lib->hasActive('front_cms')) {
                                if ($this->rbac->hasPrivilege('front_cms_setting', 'can_view')) {
                                    ?>
                                    <li style="display:none;" class="<?php echo set_Submenu('admin/frontcms/index'); ?>"><a href="<?php echo base_url(); ?>admin/frontcms"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('front_cms_setting'); ?></a></li>
                                    <?php
                                }
                            }
                            ?>
                            ...
                            if ($this->rbac->hasPrivilege('backup', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('admin/backup'); ?>"><a href="<?php echo base_url(); ?>admin/admin/backup"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('backup / restore'); ?></a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('languages', 'can_add')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('language/index'); ?>"><a href="<?php echo base_url(); ?>admin/language"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('languages'); ?></a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('custom_fields', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/customfield'); ?>"><a href="<?php echo base_url(); ?>admin/customfield"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('custom') . " " . $this->lang->line('fields'); ?></a></li>
                            <?php } 
                             if ($this->rbac->hasPrivilege('superadmin')) {
                            ?>
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/captcha'); ?>"><a href="<?php echo base_url(); ?>admin/captcha"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('captcha_setting'); ?></a></li>
                            <?php }
                            if ($this->rbac->hasPrivilege('system_fields', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/systemfield'); ?>"><a href="<?php echo base_url(); ?>admin/systemfield"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('system') . " " . $this->lang->line('fields'); ?></a></li>
                                <?php
                            } if ($this->rbac->hasPrivilege('student_profile_update', 'can_view')) {
                                ?>
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/profilesetting'); ?>"><a href="<?php echo base_url(); ?>student/profilesetting"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student') . " " . $this->lang->line('profile') . " " . $this->lang->line('update'); ?></a></li>
                                    <?php
                                }
                                     if ($this->rbac->hasPrivilege('superadmin')) {
                                    ?>
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/filetype'); ?>"><a href="<?php echo site_url('admin/admin/filetype'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('file_types'); ?></a></li>
                        <?php
                    }
                                if ($this->rbac->hasPrivilege('superadmin')) {
                                    ?>
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/updater'); ?>"><a href="<?php echo base_url(); ?>admin/updater"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('system_update') ?></a></li>
                        <?php
                    }
...
?>
    ...
    <p style="color: white;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-building-o ftlayer"></i>&nbsp;&nbsp;  Fee Management
    <span class="caret"></span></p>
    <ul class="dropdown-menu" style="background-color: #424242;
    border: none;">
      <li><a href="fee">Add fee</a></li>
      <li><a href="#">Fee List</a></li>
    </ul>
  </div> -->
