                        ...
                        <form action="<?php echo site_url('admin/concessionfeestore') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <select class="form-control" name="concession_class">
                                        <option>Select Option</option>
                                    <?php $classlist = $this->Fee_model->classlisting();?>
                                    <?php foreach($classlist as $list){?>
                                    <option value="<?=$list->id?>"><?=$list->class?></option>
                                        <?php } ?>

                                    </select>
                                    <!-- <input type="text" class="form-control" name="concession_class" value="<?php echo set_value('concession_class'); ?>" required> -->
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="concession_total_fee" value="<?php echo set_value('concession_total_fee'); ?>" required>
                            ...
                            <h4>Concession with 5%</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_five" placeholder="" type="text" class="form-control"/>
                                ...
                                <div class="row">
                                    ...
                                    <input autofocus="" name="concessionfive_installment_one" placeholder="" type="text" class="form-control" />
                                    ...
                                    <input autofocus="" name="concessionfive_installment_two" placeholder="" type="text" class="form-control" />
                                    ...
                                    <input autofocus="" name="concessionfive_installment_three" placeholder="" type="text" class="form-control" />
                                    ...
                                    <input autofocus="" name="concessionfive_installment_four" placeholder="" type="text" class="form-control" />
                                    ...
                                    <input autofocus="" name="concessionfive_installment_five" placeholder="" type="text" class="form-control" />
                                    ...
                                    <input autofocus="" name="concessionfive_installment_six" placeholder="" type="text" class="form-control" />
                                ...
                                <h4>Concession with 10%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_ten" placeholder="" type="text" class="form-control"  />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionten_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionten_installment_two" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionten_installment_three" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionten_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionten_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionten_installment_six" placeholder="" type="text" class="form-control"/>
                                ...
                                <h4>Concession with 20% or Ex. Newton Student</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_twenty" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessiontwenty_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessiontwenty_installment_two" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessiontwenty_installment_three" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessiontwenty_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessiontwenty_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessiontwenty_installment_six" placeholder="" type="text" class="form-control" />
                                ...
                                <h4>Concession with 30%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_thirty" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionthirty_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionthirty_installment_two" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionthirty_installment_three" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionthirty_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionthirty_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionthirty_installment_six" placeholder="" type="text" class="form-control" />
                                ...
                                <h4>Concession with 40%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_fourty" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionfourty_installment_one" placeholder="" type="text" class="form-control"/>
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionfourty_installment_two" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionfourty_installment_three" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionfourty_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionfourty_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionfourty_installment_six" placeholder="" type="text" class="form-control" />
                                ...
                                <h4>Concession with 50%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_fifty" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionfifty_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionfifty_installment_two" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionfifty_installment_three" placeholder="" type="text" class="form-control"/>
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionfifty_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionfifty_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionfifty_installment_six" placeholder="" type="text" class="form-control" />
                                ...
                                <h4>Concession with 75%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_sevenfive" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionsevenfive_installment_one" placeholder="" type="text" class="form-control"  />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionsevenfive_installment_two" placeholder="" type="text" class="form-control"/>
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionsevenfive_installment_three" placeholder="" type="text" class="form-control"/>
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionsevenfive_installment_four" placeholder="" type="text" class="form-control"  />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionsevenfive_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionsevenfive_installment_six" placeholder="" type="text" class="form-control" />
                                ...
                                <h4>Concession with 85%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_eightfive" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessioneightfive_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessioneightfive_installment_two" placeholder="" type="text" class="form-control"  />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessioneightfive_installment_three" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessioneightfive_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessioneightfive_installment_five" placeholder="" type="text" class="form-control"/>
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessioneightfive_installment_six" placeholder="" type="text" class="form-control"  />
                                ...
                                <h4>Concession with 90%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_ninety" placeholder="concession_total_ninety" type="text" class="form-control"  />
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionninety_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionninety_installment_two" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionninety_installment_three" placeholder="" type="text" class="form-control"/>
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionninety_installment_four" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionninety_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionninety_installment_six" placeholder="" type="text" class="form-control"  />
                                ...
                                <h4>Concession with 95%</h4>
                                  <div class="form-group">
                                    ...
                                    <input autofocus="" name="concession_total_ninefive" placeholder="" type="text" class="form-control"/>
                                ...
                                <div class="row">
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 1</label>
                                    <input autofocus="" name="concessionninefive_installment_one" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 2</label>
                                    <input autofocus="" name="concessionninefive_installment_two" placeholder="" type="text" class="form-control"   />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 3</label>
                                    <input autofocus="" name="concessionninefive_installment_three" placeholder="" type="text" class="form-control"   />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 4</label>
                                    <input autofocus="" name="concessionninefive_installment_four" placeholder="" type="text" class="form-control"   />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 5</label>
                                    <input autofocus="" name="concessionninefive_installment_five" placeholder="" type="text" class="form-control" />
                                	...
                                	<div class="col-sm-2">
                                		<div class="form-group">
                                    <label for="exampleInputEmail1">Installment 6</label>
                                    <input autofocus="" name="concessionninefive_installment_six" placeholder="" type="text" class="form-control"  />
