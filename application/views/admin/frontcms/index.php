                                    ...
                                    <div class="box-body">
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="material-switch">
                                                        <input id="enable_sidebar" name="is_active_sidebar" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_sidebar', '1', (set_value('
                                                        ', $frontcmslist->is_active_sidebar) == 1) ? TRUE : FALSE); ?>>
