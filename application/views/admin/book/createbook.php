                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/book/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body row">
                            ...
                            <div class="form-group col-md-6">
                               <?php //if ($this->rbac->hasPrivilege('generate', 'barcode')) {
                                ?>
                                <a href="<?=base_url();?>admin/main" class="btn btn-primary">

                                generate
                                </a><p class="text-danger">Please generate barcode before start filling the form</p>
                                <?php
                            if (isset($_SESSION['barcode'])) {
                               
                                ?>
                            <img src="../../<?php echo $_SESSION['barcode'];?>">
                            <input type="hidden" value="<?php echo $_SESSION['barcode'];?>" name="barcode_image">
                                <?php
                            }
                            ?> 
                            <?php //}
