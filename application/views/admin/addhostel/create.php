                        ...
                        <form id="form1" action="<?php echo site_url('admin/addroom/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="hosteladmission_no" id="admid">
                                        <option>Select option</option>
                                            <?php $admno = $this->Fee_model->adm_details();?>
                                            <?php foreach($admno as $admn){?>
                                                <option value="<?=$admn->id?>"><?=$admn->admission_no;?></option>
                                            <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Gender</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="10" name="phone_no" id="phone_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('phone_no'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="father_name" id="father_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_name'); ?>" />
                                    <span class="text-danger"><?php echo form_error('father_name'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mother Name</label><small class="req"> *</small>
                                    <input name="mother_name" id="mother_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_name'); ?>" />
                                   ...
                                   // } //else {
                                        ...
                                        foreach ($hdata as $hostelroom) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name"> <?php echo $hostelroom->hosteladmission_no; ?></td>
                                                <td class="mailbox-name"> <?php echo $hostelroom->name; ?></td>
                                                <td class="mailbox-name"> <?php echo $hostelroom->class; ?></td>
                                                <td class="mailbox-name"> <?php echo $hostelroom->gender; ?></td>
                                                <td class="mailbox-name"> <?php echo $hostelroom->phone_no; ?></td>
                                                <td class="mailbox-name"> <?php echo $hostelroom->father_name; ?></td>
                                                <td class="mailbox-name"> <?php echo $hostelroom->mother_name; ?></td>
